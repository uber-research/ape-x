...
class AtariEnv(TensorFlowEnv):
    ...
    def final_state(self, indices, name=None):
        with tf.variable_scope(name, default_name='AtariFinalState'):
            return gym_tensorflow_module.atari_final_state(self.instances, indices)
...
grayscale_palette_uint8 = (grayscale_palette * 255.0).astype(np.uint8)
